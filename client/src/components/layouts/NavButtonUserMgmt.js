...
const NavButtonUserMgmt = () => {
  ...
  const actions = [
    { icon: (<Link to="/"><ArrowBackIcon /></Link>), name: "Back", operation: 1},
    { icon: (<Link to="/import"><GroupAddIcon /></Link>), name: "Import User File", operation: 2  },
    { icon: (<Link><PersonAddIcon /></Link>), name: "Manually Add User", operation: 3 },
    { icon: <Reports />, name: "Operation 2", operation: 4 },
  ];
