...
class Test extends Component {
  ...
  initViz() {
    const vizUrl = 'https://tableau.iqeq.com/views/IQEQInvestorSolutions/Hompage?:embed=yes&:toolbar=no&:tabs=no&:device=phone&:showAppBanner=false&:display_count=n&:showVizHome=n&:origin=viz_share_link';
